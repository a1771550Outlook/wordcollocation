...
{
    [Authorize]
    public class ManageUsersController : ControllerBase<WcBase>
    {
        ...
        public ActionResult LinkLogin(string provider)
        {
            ...
            return new AccountController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "ManageUsers"), User.Identity.GetUserId());
        }
